...
import type { HttpSchema, HttpSearchParamsSerialized, HttpStatusCode, MergeHttpResponsesByStatusCode } from "zimic/http";
...
export type AutocompleteServiceSchema = HttpSchema<{
  "/places/:place": {
    ...
    GET: AutocompleteServiceOperations["Places_GetPlace"];
  };
  "/places/:place/photos/:photo/media": {
    /** @description Get a photo media with a photo reference string. */
    GET: AutocompleteServiceOperations["Places_GetPhotoMedia"];
  };
  "/places:autocomplete": {
    /** @description Returns predictions for the given input. */
    POST: AutocompleteServiceOperations["Places_AutocompletePlaces"];
  };
  "/places:searchNearby": {
    /** @description Search for places near locations. */
    POST: AutocompleteServiceOperations["Places_SearchNearby"];
  };
  "/places:searchText": {
    /** @description Text query based place search. */
    POST: AutocompleteServiceOperations["Places_SearchText"];
  };
}>;
...
export interface AutocompleteServiceComponents {
  schemas: {
    ...
    AutocompletePlacesRequest: {
       ...
       *      signal. */
      locationBias?: AutocompleteServiceComponents["schemas"]["AutocompletePlacesRequest_LocationBias"];
       ...
       *      address will be mapped to an imprecise location and used as a biasing
       *      signal. */
      locationRestriction?: AutocompleteServiceComponents["schemas"]["AutocompletePlacesRequest_LocationRestriction"];
      ...
      origin?: AutocompleteServiceComponents["schemas"]["LatLng"];
      /**
       * Format: int32
    ...
    AutocompletePlacesRequest_LocationBias: {
      ...
      rectangle?: AutocompleteServiceComponents["schemas"]["Viewport"];
      /** @description A circle defined by a center point and radius. */
      circle?: AutocompleteServiceComponents["schemas"]["Circle"];
    };
    ...
    AutocompletePlacesResponse: {
      ...
      suggestions?: AutocompleteServiceComponents["schemas"]["AutocompletePlacesResponse_Suggestion"][];
    };
    /** @description An Autocomplete suggestion result. */
    AutocompletePlacesResponse_Suggestion: {
      /** @description A prediction for a Place. */
      placePrediction?: AutocompleteServiceComponents["schemas"]["Suggestion_PlacePrediction"];
      /** @description A prediction for a query. */
      queryPrediction?: AutocompleteServiceComponents["schemas"]["Suggestion_QueryPrediction"];
    };
    ...
    Circle: {
      ...
      center: AutocompleteServiceComponents["schemas"]["LatLng"];
      /**
       * Format: double
    ...
    ContentBlock: {
      ...
      content?: AutocompleteServiceComponents["schemas"]["LocalizedText"];
      /** @description Experimental: See
       *      https://developers.google.com/maps/documentation/places/web-service/experimental/places-generative
       *      for more details.
       *
       *      References that are related to this block of content. */
      references?: AutocompleteServiceComponents["schemas"]["References"];
    };
    /** @description Experimental: See
     *      https://developers.google.com/maps/documentation/places/web-service/experimental/places-generative
     *      for more details.
    ...
    ContextualContent: {
      ...
      reviews?: AutocompleteServiceComponents["schemas"]["Review"][];
      /** @description Information (including references) about photos of this place, contexual to
       *      the place query. */
      photos?: AutocompleteServiceComponents["schemas"]["Photo"][];
      /** @description Experimental: See
       *      https://developers.google.com/maps/documentation/places/web-service/experimental/places-generative
       *      for more details.
       *
       *      Justifications for the place. */
      justifications?: AutocompleteServiceComponents["schemas"]["ContextualContent_Justification"][];
    };
    /** @description Experimental: See
     *      https://developers.google.com/maps/documentation/places/web-service/experimental/places-generative
     *      for more details.
    ...
    ContextualContent_Justification: {
       ...
       *      https://developers.google.com/maps/documentation/places/web-service/experimental/places-generative
       *      for more details. */
      reviewJustification?: AutocompleteServiceComponents["schemas"]["Justification_ReviewJustification"];
      /** @description Experimental: See
       *      https://developers.google.com/maps/documentation/places/web-service/experimental/places-generative
       *      for more details. */
      businessAvailabilityAttributesJustification?: AutocompleteServiceComponents["schemas"]["Justification_BusinessAvailabilityAttributesJustification"];
    };
    ...
    EVChargeOptions: {
      ...
      connectorAggregation?: AutocompleteServiceComponents["schemas"]["EVChargeOptions_ConnectorAggregation"][];
    };
    ...
    FuelOptions: {
      ...
      fuelPrices?: AutocompleteServiceComponents["schemas"]["FuelOptions_FuelPrice"][];
    };
    ...
    FuelOptions_FuelPrice: {
      ...
      price?: AutocompleteServiceComponents["schemas"]["Money"];
      /**
       * Format: date-time
    ...
    Justification_ReviewJustification: {
      highlightedText?: AutocompleteServiceComponents["schemas"]["ReviewJustification_HighlightedText"];
      /** @description The review that the highlighted text is generated from. */
      review?: AutocompleteServiceComponents["schemas"]["Review"];
    };
    ...
    OpeningHours_Period: {
      ...
      open?: AutocompleteServiceComponents["schemas"]["Period_Point"];
      /** @description The time that the place starts to be closed. */
      close?: AutocompleteServiceComponents["schemas"]["Period_Point"];
    };
    ...
    Photo: {
      ...
      authorAttributions?: AutocompleteServiceComponents["schemas"]["AuthorAttribution"][];
    };
    ...
    Place: {
      ...
      displayName?: AutocompleteServiceComponents["schemas"]["LocalizedText"];
       ...
       *      B at
       *      https://developers.google.com/maps/documentation/places/web-service/place-types */
      primaryTypeDisplayName?: AutocompleteServiceComponents["schemas"]["LocalizedText"];
      ...
      addressComponents?: AutocompleteServiceComponents["schemas"]["Place_AddressComponent"][];
      /** @description Plus code of the place location lat/long. */
      plusCode?: AutocompleteServiceComponents["schemas"]["Place_PlusCode"];
      /** @description The position of this place. */
      location?: AutocompleteServiceComponents["schemas"]["LatLng"];
      /** @description A viewport suitable for displaying the place on an average-sized map. */
      viewport?: AutocompleteServiceComponents["schemas"]["Viewport"];
      /**
       * Format: double
      ...
      regularOpeningHours?: AutocompleteServiceComponents["schemas"]["Place_OpeningHours"];
      /**
       * Format: int32
      ...
      attributions?: AutocompleteServiceComponents["schemas"]["Place_Attribution"][];
      /**
       * Format: int32
      ...
      currentOpeningHours?: AutocompleteServiceComponents["schemas"]["Place_OpeningHours"];
      ...
      currentSecondaryOpeningHours?: AutocompleteServiceComponents["schemas"]["Place_OpeningHours"][];
      ...
      regularSecondaryOpeningHours?: AutocompleteServiceComponents["schemas"]["Place_OpeningHours"][];
      ...
      editorialSummary?: AutocompleteServiceComponents["schemas"]["LocalizedText"];
      ...
      paymentOptions?: AutocompleteServiceComponents["schemas"]["Place_PaymentOptions"];
      /** @description Options of parking provided by the place. */
      parkingOptions?: AutocompleteServiceComponents["schemas"]["Place_ParkingOptions"];
      /** @description A list of sub destinations related to the place. */
      subDestinations?: AutocompleteServiceComponents["schemas"]["Place_SubDestination"][];
      /** @description Information about the accessibility options a place offers. */
      accessibilityOptions?: AutocompleteServiceComponents["schemas"]["Place_AccessibilityOptions"];
      /** @description The most recent information about fuel options in a gas station. This
       *      information is updated regularly. */
      fuelOptions?: AutocompleteServiceComponents["schemas"]["FuelOptions"];
      /** @description Information of ev charging options. */
      evChargeOptions?: AutocompleteServiceComponents["schemas"]["EVChargeOptions"];
      /** @description Experimental: See
       *      https://developers.google.com/maps/documentation/places/web-service/experimental/places-generative
       *      for more details.
       *
       *      AI-generated summary of the place. */
      generativeSummary?: AutocompleteServiceComponents["schemas"]["Place_GenerativeSummary"];
      /** @description Experimental: See
       *      https://developers.google.com/maps/documentation/places/web-service/experimental/places-generative
       *      for more details.
       *
       *      AI-generated summary of the area that the place is in. */
      areaSummary?: AutocompleteServiceComponents["schemas"]["Place_AreaSummary"];
    };
    /** @description Information about the accessibility options a place offers. */
    ...
    Place_AreaSummary: {
      ...
      contentBlocks?: AutocompleteServiceComponents["schemas"]["ContentBlock"][];
    };
    ...
    Place_GenerativeSummary: {
      ...
      overview?: AutocompleteServiceComponents["schemas"]["LocalizedText"];
      /** @description The detailed description of the place. */
      description?: AutocompleteServiceComponents["schemas"]["LocalizedText"];
    ...
    Place_OpeningHours: {
      ...
      periods?: AutocompleteServiceComponents["schemas"]["OpeningHours_Period"][];
       ...
       *      exceptional hours. */
      specialDays?: AutocompleteServiceComponents["schemas"]["OpeningHours_SpecialDay"][];
    };
    ...
    Review: {
      ...
      text?: AutocompleteServiceComponents["schemas"]["LocalizedText"];
      /** @description The review text in its original language. */
      originalText?: AutocompleteServiceComponents["schemas"]["LocalizedText"];
      /**
       * Format: double
      ...
      authorAttribution?: AutocompleteServiceComponents["schemas"]["AuthorAttribution"];
      /**
       * Format: date-time
    ...
    ReviewJustification_HighlightedText: {
      ...
      highlightedTextRanges?: AutocompleteServiceComponents["schemas"]["HighlightedText_HighlightedTextRange"][];
    };
    ...
    SearchNearbyRequest: {
      ...
      locationRestriction: AutocompleteServiceComponents["schemas"]["SearchNearbyRequest_LocationRestriction"];
      /**
       * Format: enum
    ...
    SearchNearbyResponse: {
      ...
      places?: AutocompleteServiceComponents["schemas"]["Place"][];
    };
    ...
    SearchTextRequest: {
      ...
      locationBias?: AutocompleteServiceComponents["schemas"]["SearchTextRequest_LocationBias"];
       ...
       *      with location_bias. */
      locationRestriction?: AutocompleteServiceComponents["schemas"]["SearchTextRequest_LocationRestriction"];
      /** @description Optional. Set the searchable EV options of a place search request. */
      evOptions?: AutocompleteServiceComponents["schemas"]["SearchTextRequest_EVOptions"];
    };
    ...
    SearchTextResponse: {
      ...
      contextualContents?: AutocompleteServiceComponents["schemas"]["ContextualContent"][];
    };
    ...
    Status: {
      ...
      details?: AutocompleteServiceComponents["schemas"]["GoogleProtobufAny"][];
      error?: {
        /**
         * Format: int32
         * @description The status code, which should be an enum value of [google.rpc.Code][google.rpc.Code].
    ...
    Suggestion_PlacePrediction: {
      ...
      text?: AutocompleteServiceComponents["schemas"]["Suggestion_FormattableText"];
       ...
       *      different ways to represent a Place prediction. Users should not try to
       *      parse `structured_format` into `text` or vice versa. */
      structuredFormat?: AutocompleteServiceComponents["schemas"]["Suggestion_StructuredFormat"];
    ...
    Suggestion_StructuredFormat: {
      ...
      mainText?: AutocompleteServiceComponents["schemas"]["Suggestion_FormattableText"];
      ...
      secondaryText?: AutocompleteServiceComponents["schemas"]["Suggestion_FormattableText"];
    };
    ...
    Viewport: {
      ...
      low?: AutocompleteServiceComponents["schemas"]["LatLng"];
      /** @description Required. The high point of the viewport. */
      high?: AutocompleteServiceComponents["schemas"]["LatLng"];
    };
  };
}
...
export interface AutocompleteServiceOperations {
    ...
    response: MergeHttpResponsesByStatusCode<[
      {
        /** @description OK */
        200: {
          body: AutocompleteServiceComponents["schemas"]["Place"];
        };
      },
      {
        /** @description Default error response */
        [StatusCode in HttpStatusCode]: {
          body: AutocompleteServiceComponents["schemas"]["Status"];
        };
      }
    ]>;
  }>;
    ...
    response: MergeHttpResponsesByStatusCode<[
      {
        /** @description OK */
        200: {
          body: AutocompleteServiceComponents["schemas"]["PhotoMedia"];
        };
      },
      {
        /** @description Default error response */
  ...
  Places_AutocompletePlaces: HttpSchema.Method<{
    request: {
      body: AutocompleteServiceComponents["schemas"]["AutocompletePlacesRequest"];
    };
    response: MergeHttpResponsesByStatusCode<[
      {
        /** @description OK */
        200: {
          body: AutocompleteServiceComponents["schemas"]["AutocompletePlacesResponse"];
        };
      },
      {
        /** @description Default error response */
  ...
  Places_SearchNearby: HttpSchema.Method<{
    request: {
      body: AutocompleteServiceComponents["schemas"]["SearchNearbyRequest"];
    };
    response: MergeHttpResponsesByStatusCode<[
      {
        /** @description OK */
        200: {
          body: AutocompleteServiceComponents["schemas"]["SearchNearbyResponse"];
        };
      },
      {
        /** @description Default error response */
  ...
  Places_SearchText: HttpSchema.Method<{
    request: {
      body: AutocompleteServiceComponents["schemas"]["SearchTextRequest"];
    };
    response: MergeHttpResponsesByStatusCode<[
      {
        /** @description OK */
        200: {
          body: AutocompleteServiceComponents["schemas"]["SearchTextResponse"];
        };
      },
      {
        /** @description Default error response */
